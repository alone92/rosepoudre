		...
		?>
			  ...
			  <?php echo $before_widget; ?>
				  ...
				  <div class="sb_tabbed">
					 ...
					 <li>
					 	<?php if ( has_post_thumbnail() && $checkbox == true ) { the_post_thumbnail( "image_header_crop", array('class' => 'asBackground') ); } elseif ( !has_post_thumbnail() && $checkbox == true ) { ?> <img src="<?php echo plugin_dir_url(__FILE__); ?>includes/images/default-thumb.png" alt="<?php the_title(); ?>" class="alignleft" width="50" height="50" /> <?php } ?>
					 	<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
						 	<span><?php echo get_the_title(); ?></span><br>
						 	<?php $category = get_the_category(); ?>
	                        <?php echo $category[0]->cat_name; ?> &nbsp·&nbsp
	                        <?php echo the_time('l j F Y') ?>
